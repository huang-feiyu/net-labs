...
void udp_out(buf_t *buf, uint16_t src_port, uint8_t *dest_ip,
             uint16_t dest_port) {
...
void udp_init() {
  //     map_init(&udp_table, sizeof(uint16_t), sizeof(udp_handler_t), 0, 0,
  //     NULL);
...
void udp_send(uint8_t *data, uint16_t len, uint16_t src_port, uint8_t *dest_ip,
              uint16_t dest_port) {
